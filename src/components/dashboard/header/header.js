    ...
    return (
        ...
        <div className="container-fluid">
            <div className="navbar-header">
                ...
                <div className="navbar-brand navbar-brand-primary navbar-brand-logo navbar-nav-padding-left">
                    <a className="svg" href="app-student-dashboard.html">
...
c4.857-0.796,10.591,1.859,10.591,1.859l0.757-3.843L89.645,42.239z" />
            ...
            <div className="collapse navbar-collapse" id="main-nav">
                ...
                <ul className="nav navbar-nav navbar-nav-bordered navbar-right">
                    {/* <!-- notifications --> */}
                    <li className="dropdown notifications updates">
                        ...
                        <ul className="dropdown-menu" role="notification">
                            ...
                            <li className="media">
                                ...
                                <div className="media-left">
                                    <img src="images/people/50/guy-2.jpg" alt="people" className="img-circle" width="30"/>
                                </div>
                            ...
                            <li className="media">
                                ...
                                <div className="media-left">
                                    <img src="images/people/50/guy-6.jpg" alt="people" className="img-circle" width="30"/>
                                </div>
                                <div className="media-body">
                            ...
                            <li className="media">
                                <div className="media-left">
                                    <span className="icon-block s30 bg-grey-200"><i className="fa fa-plus"></i></span>
                                </div>
                                <div className="media-body">
                                    ...
                                    <a href="">
                                        <img className="width-30 img-circle" src="images/people/50/woman-6.jpg" alt="people"/>
                                    </a>
                                    <a href="">
                                        <img className="width-30 img-circle" src="images/people/50/woman-3.jpg" alt="people"/>
                                    </a>
                                </div>
                            </li>
                        </ul>
                    ...
                    <li className="dropdown">
                        <a href="#" className="dropdown-toggle user" data-toggle="dropdown">
                            <img src="images/people/110/guy-5.jpg" alt="Bill" className="img-circle" width="40" /> Bill <span className="caret"></span>
                        </a>
