...
class Navigation extends Component{
    render(){
        return(
            <div className="navbar navbar-default navbar-fixed-top navbar-size-large navbar-size-xlarge paper-shadow" data-z="0" data-animated role="navigation">
                <div className="container">
                    <div className="navbar-header">
                        ...
                        <div className="navbar-brand navbar-brand-logo">
                            <a className="svg" href="index.html">
            ...
            c4.857-0.796,10.591,1.859,10.591,1.859l0.757-3.843L89.645,42.239z" />
                    ...
                    <div className="collapse navbar-collapse" id="main-nav">
                        <ul className="nav navbar-nav navbar-nav-margin-left">
                            ...
                            <li className="dropdown">
                                <a href="#" className="dropdown-toggle" data-toggle="dropdown">UI <span className="caret"></span></a>
                                <ul className="dropdown-menu">
                            ...
                            <ul className="nav navbar-nav navbar-nav-bordered navbar-nav-margin-right">
                                ...
                                <li className="dropdown user">
                                    <a href="#" className="dropdown-toggle" data-toggle="dropdown">
                                        <img src="images/people/110/guy-6.jpg" alt="" className="img-circle" /> Bill<span className="caret"></span>
                                    </a>
                                    <ul className="dropdown-menu" role="menu">
                                        <li><a href="website-student-dashboard.html"><i className="fa fa-bar-chart-o"></i> Dashboard</a></li>
                                        <li><a href="website-student-courses.html"><i className="fa fa-mortar-board"></i> My Courses</a></li>
                                        <li><a href="website-student-profile.html"><i className="fa fa-user"></i> Profile</a></li>
                                        <li><a href="login.html"><i className="fa fa-sign-out"></i> Logout</a></li>
                                    </ul>
                                </li>
                                
                            </ul>
                            <a href="login.html" className="navbar-btn btn btn-primary">Log In</a>
                        </div>
                    </div>
